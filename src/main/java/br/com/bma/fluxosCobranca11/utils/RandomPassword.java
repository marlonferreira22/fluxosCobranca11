...
public class RandomPassword {
	...
	public ConfigRandomPassword getConfiguracao() {
		return configuracao;
	}

	public void setConfiguracao(ConfigRandomPassword configuracao) {
		this.configuracao = configuracao;
	}
