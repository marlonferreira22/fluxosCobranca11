...
public interface WorkflowEngineService {
    ...
    @WebResult(name = "result", partName = "result")
    public StringArrayz simpleStartProcess(
        @WebParam(name = "username", partName = "username")
        String username,
        @WebParam(name = "password", partName = "password")
        String password,
    ...
    @WebResult(name = "AvailableUsers", partName = "AvailableUsers")
    public StringArrayz getAvailableUsers(
        @WebParam(name = "username", partName = "username")
        String username,
        @WebParam(name = "password", partName = "password")
        String password,
    ...
    @WebResult(name = "AvailableUsers", partName = "AvailableUsers")
    public StringArrayz getAvailableUsersStart(
        @WebParam(name = "username", partName = "username")
        String username,
        @WebParam(name = "password", partName = "password")
        String password,
