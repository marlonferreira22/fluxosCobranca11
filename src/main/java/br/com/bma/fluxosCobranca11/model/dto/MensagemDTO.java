...
public class MensagemDTO {
	...
	public MensagemDTO(String tblCliente, String tblAssunto, String tblPlano, String tblControle) {
		super();
	...
	public String toString() {
		return "MensagemDTO [tblCliente=" + tblCliente + ", tblAssunto=" + tblAssunto + ", tblPlano=" + tblPlano
